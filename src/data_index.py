...
from constants import EXCLUDED_CLASSES
from my_types import IndexedDataset, SampleRecord, SplitIndices
...
def build_indexed_dataset(
    ...
    effective_excluded_classes: set[str] = EXCLUDED_CLASSES if excluded_classes is None else excluded_classes
    excluded_normalized: set[str] = {
        color.casefold() for color in effective_excluded_classes
    }
    kept_colors: set[str] = {
        color
