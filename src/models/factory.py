...
from constants import ModelName, PRETRAIN_FREEZE_STAGES
from models.resnet18_scratch import ResNet18Scratch
...
def build_model(model_name: ModelName, num_classes: int) -> nn.Module:
    return build_model_with_overrides(
...
def build_model_with_overrides(
